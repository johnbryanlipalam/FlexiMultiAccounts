...
<div class="navbar navbar-static-top" style="background-color:#039be5;">
  <a href="AgentHome.php"><label style="font-family:Calibri; font-size: 20px; color:White;"><img src=" Graphics/window-back-button.png"></label></a>
  <label class="font-weight-bold" style="font-family:Calibri; font-size: 20px; color:White;">WFM FLEX SCHEDULE PORTAL
  &nbsp<img src=" Graphics/calendar-check.png"></label>
