...
<div class="container">
  ...
  <br>
	<center>
    <div class="row justify-content-center">
      <a class="btn btn-light btn-lg" role="button" href="#">
        <img src=" Graphics/download.png">&nbsp Import Files &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      </a>
    </div>
	</center>
  <br>
    <div class="row justify-content-center">
      <center>
      <a class="btn btn-light btn-lg" role="button" aria-pressed="true" href="#">
        <img src=" Graphics/email.png">&nbsp Send Notification &nbsp&nbsp&nbsp
      </a>
      </center>
    </div>
  <br>
    <div class="row justify-content-center">
      <center>
      <a class="btn btn-light btn-lg" role="button" aria-pressed="true" href="#">
        <img src=" Graphics/csv.png">&nbsp Export Summary &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      </a>
      </center>
    </div>
    <br>
